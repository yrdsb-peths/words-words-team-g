...
public class Game extends World {
        ...
        if (lastPressed != null) {
            if (currentWord == null) { // If word has not been selected
                ...
                if (lastPressed.equals("backspace")) { // allows user to select another word
                    ...
                    if (lastPressed.equals(currentWord.substring(0, 1))) { // if input matches letter to be typed,
                                                                           // remove it
                        subtractLetter();
                        // sound
                    } else {
    ...
    public void selectWord(String lastPressed) {
        ...
        for (String word : enemyHolder.keySet()) {
            // finds the word that starts with the letter the user inputed and is the
            // shortest distance from the main ship
